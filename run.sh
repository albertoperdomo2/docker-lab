...
docker run -it -p 8080:8080 --name webterminal --env AWS_ACCESS_KEY_ID=${AWS_ACCESS_KEY_ID} --env AWS_SECRET_ACCESS_KEY=${AWS_SECRET_ACCESS_KEY} cloud_computing/lab:latest
